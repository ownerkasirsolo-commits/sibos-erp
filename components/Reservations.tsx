...
// @FIX: Corrected the import path for the Reservation type.
import { Reservation } from '../features/reservations/types';
import { CalendarDays, Clock, Users, Phone, Check, X, MoreHorizontal, Plus, Search, Table } from 'lucide-react';

const Reservations: React.FC = () => {
  const [reservations, setReservations] = useState<Reservation[]>(MOCK_RESERVATIONS);
  const [filterDate, setFilterDate] = useState('2025-05-20');
