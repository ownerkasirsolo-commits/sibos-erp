...
// @FIX: HRM types have been moved to their own feature module.
import { Employee, Payroll } from '../../features/hrm/types';
import { FileText, Plus, Minus, DollarSign } from 'lucide-react';
...
const PayrollSlip: React.FC<PayrollSlipProps> = ({ employee, payrollData }) => {
  return (
    <div className="glass-panel p-6 rounded-3xl border border-orange-500/20 bg-orange-900/10">
        ...
        <button className="w-full mt-6 py-3 bg-white/10 hover:bg-white/20 text-white font-bold rounded-xl transition-colors">
            Bayar Gaji
        </button>
    </div>
  );
