...
// FIX: Corrected import path to align with the refactored file structure.
import { useGlobalSearch, SearchResultItem } from '../../features/layout/hooks/useGlobalSearch';
...
interface GlobalSearchModalProps {
    ...
    hasResults: boolean;
    // FIX: Changed prop name from `handleSearchResultClick` to `handleResultClick` to match the hook's return value.
    // FIX: Changed prop signature to accept the full `SearchResultItem` object instead of just a string.
...
const GlobalSearchModal: React.FC<GlobalSearchModalProps> = ({
    ...
    searchResults, hasResults, handleResultClick
}) => {
    if (!isSearchOpen) return null;

    // FIX: Added logic to group flat searchResults array by type for correct rendering.
