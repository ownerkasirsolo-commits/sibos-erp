...
const menuGroups = [
    ...
    { label: 'Digital & Marketing', items: [ { id: 'omnichannel', label: 'Omnichannel', icon: Globe }, { id: 'marketing', label: 'Pusat Pemasaran', icon: Megaphone }, { id: 'website', label: 'Website Usaha', icon: Laptop }, { id: 'google', label: 'Google Business', icon: MapPin } ] } 
];
...
const Sidebar: React.FC<SidebarProps> = ({ 
    ...
    // Filter Menu Groups based on active modules in config
    const filteredMenuGroups = useMemo(() => {
        ...
        return menuGroups.map(group => ({
            ...group,
            items: group.items.filter(item => activeModules.includes(item.id as any))
