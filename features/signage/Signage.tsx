...
import { useSignageLogic } from './hooks/useSignageLogic';

const Signage: React.FC = () => {
  const { contentList, activeContent, toggleActive } = useSignageLogic();
            ...
            <div className="space-y-6">
                <div className="glass-panel p-6 rounded-3xl">
                    ...
                    <div className="aspect-video bg-black rounded-xl overflow-hidden relative border border-white/10">
                         {activeContent ? (
                            <img src={activeContent.url} className="w-full h-full object-cover" />
                         ) : (
